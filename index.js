...
app.get('/', function(req, res) {
    res.send('This is an image search abstraction layer. Add your search string after the domain (ex. .../api/searchFor/my search string). Get recent searches with /api/recentSearches');
});
